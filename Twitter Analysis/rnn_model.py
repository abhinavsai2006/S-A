...
# This script builds a sentiment classifier using RNN (Recurrent Neural Network) on the IMDB dataset sample.
...
if __name__ == "__main__":
    ...
    embed_dim = 128
    hidden_size = 128
    model = SentimentRNN(vocab_size, embed_dim, hidden_size).to(device)
