...
# This script builds a sentiment classifier using LSTM (Deep Learning) on the NLTK movie_reviews dataset.
...
if __name__ == "__main__":
    ...
    embed_dim = 128
    hidden_size = 128
    model = SentimentLSTM(vocab_size, embed_dim, hidden_size).to(device)
