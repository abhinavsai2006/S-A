# Delhi Traffic Analysis - ANN Regressor Model (PyTorch)
# This script trains and tests an Artificial Neural Network Regressor for travel time prediction.
...
def train_and_evaluate_model():
    """Train and evaluate the ANN Regressor model."""
    ...
    print("Training ANN Regressor model...")
    model = ANNRegressor(input_size).to(device)
    ...
    torch.save(model.state_dict(), 'ann_regressor_model.pth')
    joblib.dump(scaler, 'scaler.pkl')
    joblib.dump(encoder, 'encoder.pkl')
    print("\nModel saved as 'ann_regressor_model.pth'")
