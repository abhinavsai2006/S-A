# Delhi Traffic Analysis - SVM Regressor Model
# This script trains and tests an SVM Regressor model for travel time prediction.
...
def train_and_evaluate_model():
    """Train and evaluate the SVM Regressor model."""
    ...
    joblib.dump(model, 'svm_regressor_model.pkl')
    joblib.dump(scaler, 'scaler.pkl')
    joblib.dump(encoder, 'encoder.pkl')
    print("\nModel saved as 'svm_regressor_model.pkl'")
