# Delhi Traffic Analysis - CNN Regressor Model (PyTorch)
# This script trains and tests a Convolutional Neural Network Regressor for travel time prediction.
...
class CNNRegressor(nn.Module):
    def __init__(self, input_size):
        ...
        conv_output_size = (conv_output_size - 1) // 2  # After first pool
        conv_output_size = (conv_output_size - 1) // 2  # After second pool
        conv_output_size = (conv_output_size - 1) // 2  # After third pool
...
def train_and_evaluate_model():
    """Train and evaluate the CNN Regressor model."""
    ...
    print("Training CNN Regressor model...")
    ...
    torch.save(model.state_dict(), 'cnn_regressor_model.pth')
    joblib.dump(scaler, 'scaler.pkl')
    joblib.dump(encoder, 'encoder.pkl')
    print("\nModel saved as 'cnn_regressor_model.pth'")
