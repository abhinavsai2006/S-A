# Delhi Traffic Analysis - KNN Regressor Model
# This script trains and tests a KNN Regressor model for travel time prediction.
...
def train_and_evaluate_model():
    """Train and evaluate the KNN Regressor model."""
    ...
    joblib.dump(model, 'knn_regressor_model.pkl')
    joblib.dump(scaler, 'scaler.pkl')
    joblib.dump(encoder, 'encoder.pkl')
    print("\nModel saved as 'knn_regressor_model.pkl'")
