# Delhi Traffic Analysis - RNN Regressor Model (PyTorch)
# This script trains and tests a Recurrent Neural Network Regressor for travel time prediction.
...
def train_and_evaluate_model():
    """Train and evaluate the RNN Regressor model."""
    ...
    print("Training RNN Regressor model...")
    model = RNNRegressor(input_size).to(device)
    ...
    torch.save(model.state_dict(), 'rnn_regressor_model.pth')
    joblib.dump(scaler, 'scaler.pkl')
    joblib.dump(encoder, 'encoder.pkl')
    print("\nModel saved as 'rnn_regressor_model.pth'")
