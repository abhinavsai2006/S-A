# CNN Model for Weather Data Classification
# This script builds a classifier using CNN on the Combined12.csv dataset.
...
model = WeatherCNN(input_size, num_classes).to(device)
