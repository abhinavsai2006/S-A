# BiLSTM Model for Weather Data Classification
# This script builds a classifier using BiLSTM on the Combined12.csv dataset.
...
model = WeatherBiLSTM(input_size, hidden_size, num_classes).to(device)
