# GRU Model for Weather Data Classification
# This script builds a classifier using GRU on the Combined12.csv dataset.
...
model = WeatherGRU(input_size, hidden_size, num_classes).to(device)
