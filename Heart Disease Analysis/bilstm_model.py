# BiLSTM Heart Disease Prediction Model
# This script builds a heart disease classifier using BiLSTM (Bidirectional LSTM) on the heart disease dataset.
...
class HeartDiseaseBiLSTM(nn.Module):
    def __init__(self, input_size, hidden_size):
        super(HeartDiseaseBiLSTM, self).__init__()
...
if __name__ == "__main__":
    ...
    hidden_size = 128
    model = HeartDiseaseBiLSTM(input_size, hidden_size).to(device)
