# ANN Heart Disease Prediction Model
# This script builds a heart disease classifier using ANN (Artificial Neural Network) on the heart disease dataset.
...
if __name__ == "__main__":
    ...
    model = HeartDiseaseANN(input_size).to(device)
