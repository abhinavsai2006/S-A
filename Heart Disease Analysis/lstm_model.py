# LSTM Heart Disease Prediction Model
# This script builds a heart disease classifier using LSTM (Deep Learning) on the heart disease dataset.
...
class HeartDiseaseLSTM(nn.Module):
    def __init__(self, input_size, hidden_size):
        super(HeartDiseaseLSTM, self).__init__()
...
if __name__ == "__main__":
    ...
    hidden_size = 128
    model = HeartDiseaseLSTM(input_size, hidden_size).to(device)
